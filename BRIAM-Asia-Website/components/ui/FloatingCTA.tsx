    ...
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-2 rounded-md bg-accent px-4 py-2.5 text-sm font-medium text-white shadow-[0_16px_40px_-10px_rgba(119,61,189,0.85)] md:bottom-6 md:right-6 md:px-5 md:py-2.5"
        >
          {!reduce && (
